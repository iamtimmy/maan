...
@set DEBUGCFLAGS=
@set LJCOMPILE=cl /nologo /c /O2 /W3 /D_CRT_SECURE_NO_DEPRECATE /D_CRT_STDIO_INLINE=__declspec(dllexport)__inline /DLUAJIT_ENABLE_LUA52COMPAT /EHsc /GS /Gw /sdl- /fp:fast /Oi /Oy /MT /Zc:forScope /Zc:inline
